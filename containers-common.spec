...
License: Apache-2.0
URL: https://github.com/podman-container-tools/container-libs/tags
...
install -Dpm644 -t %{buildroot}%{_sysconfdir}/containers/ common/tests/policy.json
install -Dpm644 -t %{buildroot}%{_datadir}/containers/ common/pkg/config/containers.conf
install -Dpm644 -t %{buildroot}%{_datadir}/containers/ common/pkg/seccomp/seccomp.json
